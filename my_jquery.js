...
$(document).ready(function(){
        ...
        $("#nav_bar").css({"position":"fixed", "display":"block"});
        $("#nav_open").css({"position":"fixed", "left":"5%"}); 
        ...
        $("button[id^='m']").click(function(){
            ...
            $("#hiddenInput").val($(this)[0].value);
            $("#uniqueID").val(($(this)[0].id).slice(1));
        });
...
function cal_price(){
    ...
    var total_price = $("#hiddenInput").val();
...
//    alert(order_info["share_array"]["items_array"][0]["m_id"]);
         ...
         tr_temp.append(
                ...
                $('<td>').html(
                    $('<input>').attr("type","button")
                                .attr("value","X")
                                .click(function() {
                                    $("#tprice").val( parseInt($("#tprice").val()) - parseInt($(this).parent().prev().prev().text()) );
    ...
    tr_temp.data("m_price", $("#hiddenInput").val());
/*
    $("#orderList").find("tr").each(function(index, value){
        if(index>=1){
            alert(($(this).data("item_array")["m_id"]));
            alert(($(this).data("item_array")["quantity"]));
        }
    });
*/
       ...
       /* alert(msg);
        ...
        if(msg[q]['multiple_choice'] == 1){
            ...
            for(var i =0; i<msg[q]['ais'].length ;++i){
                ...
                htmldata =htmldata + "<label class=\"w3-checkbox\"><input type=\"checkbox\"><span class=\"w3-checkmark\"></span> "+msg[q]['ais'][i].name+"</label>";
          ...
          //  $("#materialblock").find("input:eq(0)").attr("checked", "true");
